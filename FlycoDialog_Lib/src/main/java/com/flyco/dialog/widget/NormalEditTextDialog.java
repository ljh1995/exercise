...
import com.flyco.dialog.widget.internal.BaseAlertEditDialog;

@SuppressWarnings("deprecation")
public class NormalEditTextDialog extends BaseAlertEditDialog<NormalEditTextDialog> {
    /** title underline */
    ...
    public NormalEditTextDialog(Context context) {
        super(context);
    ...
    /** set style(设置style) */
    public NormalEditTextDialog style(int style) {
        this.mStyle = style;
        return this;
    }

    /** set title underline color(设置标题下划线颜色) */
    public NormalEditTextDialog titleLineColor(int titleLineColor) {
        this.mTitleLineColor = titleLineColor;
        return this;
    }

    /** set title underline height(设置标题下划线高度) */
    public NormalEditTextDialog titleLineHeight(float titleLineHeight_DP) {
        this.mTitleLineHeight = titleLineHeight_DP;
        return this;
    }

    /** set divider color between btns(设置btn分割线的颜色) */
    public NormalEditTextDialog dividerColor(int dividerColor) {
